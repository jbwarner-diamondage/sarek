...
process MapReads {
    ...
    convertToFastq = hasExtension(inputFile1, "bam") ? "gatk --java-options '-Xms60g -Xmx60g -XX:-UseGCOverheadLimit -XX:-UseParallelGC' SamToFastq --INPUT=${inputFile1} --FASTQ=/dev/stdout --INTERLEAVE=true --NON_PF=true --MAX_RECORDS_IN_RAM=5000000 | \\" : ""
